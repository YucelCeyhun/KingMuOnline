...
// -----------------------------------------------------------------------
#ifdef USE_ZTEAM_ENCODE
BYTE XorTableLock[]	= { 0xD4, 0x7B, 0x2B };
#endif

#ifdef USE_MYENCODE_100716
BYTE XorTableLock[] = { 0x93, 0xD5, 0x16 };
#endif

ScriptEncode gScriptEncode;
...
int ScriptEncode::GetInt()
{
	return (int)TokenNumber;
}

float ScriptEncode::GetFloat()
{
	return TokenNumber;
}
