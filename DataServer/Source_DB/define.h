...
#ifdef USE_GLOBAL
#define MAX_PASSLENGHT				20		// Global
#endif
#ifdef USE_KOREA
#define MAX_PASSLENGHT				12		// Korea
#endif
#ifdef USE_JAPAN
#define MAX_PASSLENGHT				10		// Japan
#endif
...
#define MAX_DBINVENTORY				((MAX_INVENTORYMAP+MAX_EQUIPMENT+MAX_PSHOP_SIZE)*MAX_ITEMDBBYTE) // (8x8x10)+120 데이터베이스 읽기&저장되는 인벤토리데이터 크기
...
#define MAX_CLASSTYPE				6		// 최대 종족 개수
