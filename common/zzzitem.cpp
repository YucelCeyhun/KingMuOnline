...
void CItem::Convert(int type, BYTE Option1, BYTE Option2, BYTE Option3,  BYTE Attribute2, BYTE SetOption, BYTE ItemEffectEx, BYTE SocketOption[5], BYTE SocketIndex, BYTE DbVersion)
{
	...
	if ( ((_type >= ITEMGET(12,3) ) && (_type <= ITEMGET(12,6) ) ) || (_type == ITEMGET(13,30) || _type == ITEMGET(12,41) || _type == ITEMGET(12,42) || _type == ITEMGET(12,43) || (_type >= ITEMGET(12,36) && _type <= ITEMGET(12,40)) || (_type >= ITEMGET(12,236) && _type <= ITEMGET(12,255)) ))
	{
		Attribute2=0;
	}
	...
	if ( gSetItemOption.IsSetItem(_type) != 0 && SetOption != 255 && SOption != 0) // Fix Ancient Item with Excellent Options
	{
	...
	if(g_SocketOption.IsActive(this) == 1)
	{
		...
		if(g_SocketOption.IsSocketOption(this) == 1) // Fix Socket Item with all Anothers Options
		{	//Zero SET
			//this->m_ItemOptionEx = 0;
			//this->m_SetOption = 0;
			//Attribute2 = 0;
	...
	if ( p->RequireLevel != 0 )
	{
		...
		else if ( _type >= ITEMGET(12,236) && _type <= ITEMGET(12,255) )
		{
			this->m_RequireLevel = p->RequireLevel;
		}
	...
	if ( p->Defense > 0 )	
	{
		...
		else 
		{
			...
			if ( ( _type >= ITEMGET(12,36) && _type <= ITEMGET(12,40)) || ( _type >= ITEMGET(12,236) && _type <= ITEMGET(12,255)) )
			{
	...
	if ( Option2 != 0 )
	{
		...
		if ( _type >= ITEMGET(12,236) && _type <= ITEMGET(12,255) )	//Season 4.7 All Wings
		{
			this->m_Special[this->m_SpecialNum] = 84;
			this->m_Option2 = 1;
		}
	...
	if ( Option3 != 0 )
	{
		...
		if ( _type == ITEMGET(12,0) )	// Wings of Fairy
		{
			this->m_Special[this->m_SpecialNum] = 85;
			this->m_Option3 = Option3;
		}
		else if ( _type == ITEMGET(12,1) ) // Wings of Angel
		{
			this->m_Special[this->m_SpecialNum] = 81;
			this->m_Option3 = Option3;
			this->m_RequireStrength +=  Option3 * 4;
		}
		else if ( _type == ITEMGET(12,2) ) // Wings of Satan
		{
			this->m_Special[this->m_SpecialNum] = 80;
			this->m_Option3 = Option3;
			this->m_RequireStrength +=  Option3 * 4;
		}
		else if ( _type == ITEMGET(12,3) ) // Wings of Spirits
		{
			this->m_Special[this->m_SpecialNum] = 80;
			this->m_Option3 = Option3;
			this->m_RequireStrength +=  Option3 * 4;
		...
		else if ( _type == ITEMGET(12,6) ) // Wings of Darkness
		{
			this->m_Option3 = Option3;
			this->m_RequireStrength +=  Option3 * 4;
		...
		else if ( _type == ITEMGET(13,3) ) // Dinorant Pet
		{
			this->m_Option3 = Option3;
		...
		if ( _type == ITEMGET(12,37) ) // Wing of Vortex
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		if ( _type == ITEMGET(12,40) ) // Mantle of Emperor
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,41) ) // Wings of Curse
		{
			this->m_Special[this->m_SpecialNum] = 81;
			this->m_Option3 = Option3;
			this->m_RequireStrength +=  Option3 * 4;
		}
		else if ( _type == ITEMGET(12,42) ) // Wings of Despair
		{
			this->m_Option3 = Option3;
			this->m_RequireStrength +=  Option3 * 4;
		...
		else if ( _type == ITEMGET(12,43) ) // Wings of Dimension
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		// 2.5 Level Wings (Options)
		else if ( _type == ITEMGET(12,236) ) // Wings of Magic
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,237) ) // Wings of Chaos
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,238) ) // Wings of Life
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,239) ) // Cape of Death
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		// 4th Level Wings (Options)
		else if ( _type == ITEMGET(12,240) ) // Wings of Heaven
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,241) ) // Wings of Demonic
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,242) ) // Wings of Blossom
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,243) ) // Wings of Thunder
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,244) ) // Wings of Raven
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,245) ) // Wings of Eternal
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		// Special Wings (Options)
		else if (_type == ITEMGET(12,246)) // Wings of Legend
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if (_type == ITEMGET(12,247)) // Wings of Flaming
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if (_type == ITEMGET(12,248)) // Wings of Nightwish
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,249) ) // Wings of Imperial Dragon
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,250) ) // Wings of Conqueror
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,251) ) // Wings of Angel and Devil
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,252) ) // Wings of Deathless
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
	...
	if ( _type >= ITEMGET(12,36) && _type <= ITEMGET(12,40) || _type >= ITEMGET(12,236) && _type <= ITEMGET(12,255) || _type == ITEMGET(12,43))
	{
		if ( (this->m_NewOption &1) )
		{
...
void CItem::Value()
{
	...
	if ( this->m_Type == ITEMGET(4,15) ) // Arrow of Bows
	{
		int lc10 = 70;
	...
	else if ( this->m_Type == ITEMGET(4,7) ) // Bolt of Crossbows
	{
		int lc11;
	...
	else if ( this->m_Type == ITEMGET(14,42) ) // Harmony
	{
		Gold = 9000000;
	}
	else if ( this->m_Type == ITEMGET(14,43) ) // Lower Crystal
	{
		Gold = 9000000;
	}
	else if ( this->m_Type == ITEMGET(14,44) ) // Higher Crystal
	{
		Gold = 9000000;
	}
	else if ( this->m_Type == ITEMGET(14,240) ) // Level
	{
		Gold = 60000000;
	}
	else if ( this->m_Type == ITEMGET(14,241) ) // Luck
	{
		Gold = 30000000;
	}
	else if ( this->m_Type == ITEMGET(14,242) ) // Skill
	{
		Gold = 30000000;
	}
	else if ( this->m_Type == ITEMGET(14,243) ) // Option
	{
		Gold = 30000000;
	}
	else if ( this->m_Type == ITEMGET(14,244) ) // Excellent
	{
		Gold = 60000000;
	}
	else if ( this->m_Type == ITEMGET(14,245) ) // Ancient
	{
		Gold = 60000000;
	}
	else if ( this->m_Type == ITEMGET(14,246) ) // Socket
	{
		Gold = 60000000;
	}
	// CUSTOM JEWELS BUNDLED
	else if (this->m_Type == ITEMGET(12,150)) // Pack Of Level
	{
		Gold = (this->m_Level+1)*9000000*10;
	}
	else if (this->m_Type == ITEMGET(12,151)) // Pack Of Luck
	{
		Gold = (this->m_Level+1)*9000000*10;
	}
	else if (this->m_Type == ITEMGET(12,152)) // Pack Of Skill
	{
		Gold = (this->m_Level+1)*9000000*10;
	}
	else if (this->m_Type == ITEMGET(12,153)) // Pack Of Option
	{
		Gold = (this->m_Level+1)*9000000*10;
	}
	else if (this->m_Type == ITEMGET(12,154)) // Pack Of Excellent
	{
		Gold = (this->m_Level+1)*9000000*10;
	}
	else if (this->m_Type == ITEMGET(12,155)) // Pack Of Ancient
	{
		Gold = (this->m_Level+1)*9000000*10;
	}
	else if (this->m_Type == ITEMGET(12,156)) // Pack Of Socket
	{
		Gold = (this->m_Level+1)*9000000*10;
	}
	...
	else if (this->m_Type == ITEMGET(14,170) ) // Crystal Feather Price
	{
		Gold = 3000000; // Custom Item
	}
	else if (this->m_Type == ITEMGET(14,171) ) // Legend Amulet Price
	{
		Gold = 6000000; // Custom Item
	}
	else if (this->m_Type == ITEMGET(14,172) ) // Divine Stone Price
	{
		Gold = 3000000; // Custom Item
	}
	else if (this->m_Type == ITEMGET(14,173) ) // Jewel of Dark Chaos
	{
		Gold = 180000; // Custom Item
	}
	else if (this->m_Type == ITEMGET(14,174) ) // Deathless Amulet Price
	{
		Gold = 6000000; // Custom Item
	}
	else if (this->m_Type == ITEMGET(14,200) ) // Gem of Life (Fire)
	{
		Gold = 30000000; // Custom Item
	}
	else if (this->m_Type == ITEMGET(14,201) ) // Gem of Life (Earth)
	{
		Gold = 30000000; // Custom Item
	}
	else if (this->m_Type == ITEMGET(14,202) ) // Gem of Life (Water)
	{
		Gold = 30000000; // Custom Item
	}
	else if ( this->m_Type == ITEMGET(14,210) ) // Book of Summon Dark Phoenix
	{
		Gold = 12000000;
	}
	else if ( this->m_Type == ITEMGET(14,211) ) // Book of Summon Giant Dragon
	{
		Gold = 12000000;
	}
	else if ( this->m_Type == ITEMGET(14,212) ) // Book of Summon Kundun Boss
	{
		Gold = 12000000;
	}
	else if ( this->m_Type == ITEMGET(14,213) ) // Book of Summon Giant Drakan
	{
		Gold = 12000000;
	}
	else if ( this->m_Type == ITEMGET(14,214) ) // Book of Summon Iron Knight
	{
		Gold = 12000000;
	}
	else if ( this->m_Type == ITEMGET(14,215) ) // Book of Summon Selupan Boss
	{
		Gold = 12000000;
	}
	else if ( this->m_Type == ITEMGET(14,216) ) // Book of Summon Thunder Nappin
	{
		Gold = 12000000;
	}
	else if ( this->m_Type == ITEMGET(14,217) ) // Book of Summon Hell Maine
	{
		Gold = 12000000;
	}
	else if ( this->m_Type == ITEMGET(14,31) ) // Jewel of Guardian Price
	{
		Gold = 60000000;
	}
	...
	else if (this->m_Type == ITEMGET(13,64) ) // Demon Pet Price
	{
		Gold = 22000;
	}
	else if( this->m_Type == ITEMGET(13,65) ) // Fairy Pet Price
	{
		Gold = 22000;
	}
	else if (this->m_Type == ITEMGET(13,67) ) // Rudolf Pet Price
	{
		Gold = 22000;
	}
	else if( this->m_Type == ITEMGET(13,76) ) // Panda Ring Price
	{
		Gold = 3000;
	}
	else if( this->m_Type == ITEMGET(13,80) ) // Panda Pet Price
	{
		Gold = 22000;
	}
	else if( this->m_Type == ITEMGET(13,97) ) // Dark Wolf Pet
	{
		Gold = 50000;
	}
	else if( this->m_Type == ITEMGET(13,98) ) // Sable Fang Pet
	{
		Gold = 50000;
	}
	else if( this->m_Type == ITEMGET(13,77) ) // Skeleton Pet Price
	{
		Gold = 22000;
	}
	else if( this->m_Type == ITEMGET(13,78) ) // Unicorn Pet Price
	{
		Gold = 22000;
	}
	else if( this->m_Type == ITEMGET(13,79) ) // Dragon Pet Price
	{
		Gold = 22000;
	}
	else if( this->m_Type == ITEMGET(13,140) ) // Horrocrux of Fire Price
	{
		Gold = 90000000;
	}
	else if( this->m_Type == ITEMGET(13,141) ) // Horrocrux of Water Price
	{
		Gold = 90000000;
	}
	else if( this->m_Type == ITEMGET(13,142) ) // Horrocrux of Earth Price
	{
		Gold = 90000000;
	}
	else if( this->m_Type == ITEMGET(13,143) ) // Horrocrux of Wind Price
	{
		Gold = 90000000;
	}
	else if( this->m_Type == ITEMGET(13,144) ) // Horrocrux of Thunder Price
	{
		Gold = 90000000;
	}
	else if( this->m_Type == ITEMGET(13,145) ) // Horrocrux of Ice Price
	{
		Gold = 90000000;
	}
	else if( this->m_Type == ITEMGET(13,150) ) // Fragment of Fire Price
	{
		Gold = 15000;
	}
	else if( this->m_Type == ITEMGET(13,151) ) // Fragment of Earth Price
	{
		Gold = 15000;
	}
	else if( this->m_Type == ITEMGET(13,152) ) // Fragment of Water Price
	{
		Gold = 15000;
	}
	...
	else if ( this->m_Type == ITEMGET(14,101) || //Box of Pandora (Season 4.9)
			  this->m_Type == ITEMGET(14,102) || //Legendary Box (1) (Season 4.9)
			  this->m_Type == ITEMGET(14,103) || //Legendary Box (2) (Season 4.9)
		      this->m_Type == ITEMGET(14,104) )  //Legendary Box (3) (Season 4.9)
	{
		Gold = 6000000;
	}
	...
	else if ( this->m_Type == ITEMGET(13,0) )		// Angel Pet
	{
		Gold = 12200;
	}
	else if ( this->m_Type == ITEMGET(13,1) )		// Satan Pet
	{
		Gold = 22000;
	}
	else if ( this->m_Type == ITEMGET(13,52) || this->m_Type == ITEMGET(13,53) )	// Condor Flame and Condor Feather
	{
		Gold = 3000000;
	}
	...
	else if ( (Type == 12 && this->m_Type > ITEMGET(12,6) && (this->m_Type < ITEMGET(12,36) && this->m_Type > ITEMGET(12,43)) && (this->m_Type < ITEMGET(12,236) && this->m_Type > ITEMGET(12,255)) ) || Type == 13 || Type == 15 ) //Third Wings Addition
	{
	...
	else
	{
		switch ( this->m_Level )
		{
			...
			case 14:	Level2 += 249;  break;//Fix Buy and Sell Price for +14 Items
			case 15:	Level2 += 254;	break;//Fix Buy and Sell Price for +15 Items
		}

		if ( Type == 12 && this->m_Type <= ITEMGET(12,6) )	// 1st & 2nd Levels Wings
		{
			Gold = (Level2+40)*Level2*Level2*11+40000000;
		}
		else if( Type == 12 && (this->m_Type >= ITEMGET(12,36) && this->m_Type <= ITEMGET(12,40)) ) //3rd Level Wings
		{
			Gold = (Level2+40)*Level2*Level2*11+40000000;
		}
		else if( Type == 12 && (this->m_Type >= ITEMGET(12,236) && this->m_Type <= ITEMGET(12,255)) ) //All Wings
		{
			Gold = 1000000000;	// -> Test 1 Billon
		}
		else if( Type == 12 && (this->m_Type >= ITEMGET(12,41) && this->m_Type <= ITEMGET(12,43)) ) //All Summoner LeWings
		{
			Gold = (Level2+40)*Level2*Level2*11+40000000;
		}
		else
...
//#endif
	...
	if ( (this->m_Type < ITEMGET(14,0) || this->m_Type >  ITEMGET(14,8)) &&
		  ...
		  this->m_Type != ITEMGET(13,76) && //Season 4.6 Panda Ring
		  this->m_Type != ITEMGET(13,80) && //Season 4.6 Panda Pet
		  this->m_Type != ITEMGET(13,78) && //Season 4.9 Unicorn Pet
		  this->m_Type != ITEMGET(13,79) && //Season 4.9 Sparky Pet
		  this->m_Type != ITEMGET(13,77) && //Season 4.9 Skeleton Pet
...
void CItem::SetPetItemInfo(int petlevel, int petexp)
{
	if ( this->m_Type == ITEMGET(13,4) )
	{
		...
		this->Convert(this->m_Type, this->m_Option1, this->m_Option2, this->m_Option3, this->m_NewOption, this->m_SetOption, this->m_ItemOptionEx, NULL, 0xFF, CURRENT_DB_VERSION);
		this->PetValue();
...
int CItem::IsSeason7WingOpGetOnePercentDamage()		// -> Wings Level 2.5
{
	if ( this->m_Type >= ITEMGET(12,236) && this->m_Type <= ITEMGET(12,239) )
	{
		if ( this->m_Durability < 1.0f )
		{
			return 0;
...
int CItem::IsFourthWingOpGetOnePercentDamage()
{
	if ( this->m_Type >= ITEMGET(12,240) && this->m_Type <= ITEMGET(12,245) )
	{
		if ( this->m_Durability < 1.0f )
		{
			return 0;
...
int CItem::IsSpecialWingOpGetOnePercentDamage()
{
	if ( this->m_Type >= ITEMGET(12,246) && this->m_Type <= ITEMGET(12,249) || this->m_Type == ITEMGET(12,252) ) // -> Wings of Deathless (Added: 22-12-16)
	{
		if ( this->m_Durability < 1.0f )
		{
			return 0;
...
int CItem::IsSeason8WingOpGetOnePercentDamage()
{
	if ( this->m_Type >= ITEMGET(12,250) && this->m_Type <= ITEMGET(12,251) )
	{
		if ( this->m_Durability < 1.0f )
		{
			return 0;
...
int CItem::NormalWeaponDurabilityDown(int defense, int aIndex)
{
	...
	if ( damagemin == 0 )
	{
		LogAdd("[NormalWeaponDurabilityDown] Minimum Damage is: 0");
		return 0;
	}
...
int CItem::ArmorDurabilityDown(int damagemin, int aIndex)
{
	...
	if ( def == 0 )
	{
		LogAdd("[ArmorDurabilityDown] Defense is: 0");
		return 0;
	}
...
{
	if(type < 0 || type > MAX_TYPE_ITEMS || index < 0 || index > MAX_SUBTYPE_ITEMS)
	{
		return 0;
	}
...
int ItemGetDurability(int index, int itemLevel, int ExcellentItem, int SetItem)
{
	...
	else if ( itemLevel >= 5 )
	{
		...
		{
			dur=ItemAttribute[index].Durability + itemLevel*2+14;
		}
		else
		{
	...
	if ( (index < ITEMGET(12,3) || index > ITEMGET(12,6) ) &&
		  ...
		  index != ITEMGET(12,42) &&
		  index != ITEMGET(12,43) &&
		  index != ITEMGET(12,236) &&
		  index != ITEMGET(12,237) &&
		  index != ITEMGET(12,238) &&
		  index != ITEMGET(12,239) &&
		  index != ITEMGET(12,240) &&
		  index != ITEMGET(12,241) &&
		  index != ITEMGET(12,242) &&
		  index != ITEMGET(12,243) &&
		  index != ITEMGET(12,244) &&
		  index != ITEMGET(12,245) &&
		  index != ITEMGET(12,246) &&
		  index != ITEMGET(12,247) &&
		  index != ITEMGET(12,248) &&
		  index != ITEMGET(12,249) &&
		  index != ITEMGET(12,250) &&
		  index != ITEMGET(12,251) &&
		  index != ITEMGET(12,252))		// -> Wings of Deathless (Added: 22-12-16)
	{
		if ( SetItem != 0 )
			dur +=20;
