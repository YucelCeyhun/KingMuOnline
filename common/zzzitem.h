...
#define MAKE_ITEMNUM(ITYPE, IINDEX) MakeItemNumber(ITYPE, IINDEX)
...
public:
	...
	int IsFourthWingOpGetOnePercentDamage();
	int IsSeason7WingOpGetOnePercentDamage();
	int IsSpecialWingOpGetOnePercentDamage();
	int IsSeason8WingOpGetOnePercentDamage();
