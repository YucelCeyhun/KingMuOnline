...
struct PMSG_ANS_REGISTER_EVENTCHIP
{
    ...
    char szUID[11];
    char bSUCCESS;
    int nEVENT_CHIPS;//Fix Golden Archer
};
...
struct PMSG_REQ_PCBANGUSER_INFO
{
	PBMSG_HEAD h;
	short aIndex;
	BYTE btServerType;
...
struct PMSG_PCBANGUSER_RECVINFO
{
	PBMSG_HEAD h;
	short aIndex;
	char szAccountID[11];
...
struct PMSG_PCBANGUSER_UPDINFO
{
    PBMSG_HEAD h;
    short aIndex;
    char szAccountID[11];
...
public:
    ...
    void RequestNewPCBangInfo(int aIndex, PMSG_REQ_PCBANGUSER_INFO * lpMsg);
    void ResultNewPCBangInfo(int aIndex, PMSG_PCBANGUSER_UPDINFO * lpMsg);
