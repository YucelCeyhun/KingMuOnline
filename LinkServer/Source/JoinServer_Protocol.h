...
struct PMSG_ANS_MAPSVRMOVE
{
    ...
    char		szAccountID[11];
    char		szCharName[11];
    USHORT		wCurMapSvrCode;//USHORT - WORD
    USHORT		wDstMapSvrCode;//USHORT - WORD
    USHORT		wMapNumber;//USHORT - WORD
    UCHAR		btX;//UCHAR - BYTE
    UCHAR		btY;//UCHAR - BYTE
    int			iResult;
    int			iJoinAuthCode1;
    int			iJoinAuthCode2;
    int			iJoinAuthCode3;
...
struct PMSG_REQ_MAPSVRAUTH
{
    ...
    char		szAccountID[11];
    char		szCharName[11];
    USHORT		wDstMapSvrCode;//Original: USHORT changed to: WORD
    int			iJoinAuthCode1;
    int			iJoinAuthCode2;
    int			iJoinAuthCode3;
    int			iJoinAuthCode4;
...
struct PMSG_ANS_MAPSVRAUTH
{
    ...
    UCHAR 		btBlockCode;//Original: UCHAR changed to: BYTE
    int			Magumsa;
    BYTE		m_iPCRoom;
};
