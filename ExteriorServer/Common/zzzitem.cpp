...
void CItem::Convert(int type, BYTE Option1, BYTE Option2, BYTE Option3,  BYTE Attribute2, BYTE SetOption, BYTE ItemEffectEx, BYTE SocketOption[5], BYTE SocketIndex, BYTE DbVersion)
{
	...
	if ( ((_type >= ITEMGET(12,3) ) && (_type <= ITEMGET(12,6) ) ) || (_type == ITEMGET(13,30) || _type == ITEMGET(12,41) || _type == ITEMGET(12,42) || _type == ITEMGET(12,43) || (_type >= ITEMGET(12,36) && _type <= ITEMGET(12,40)) || (_type >= ITEMGET(12,240) && _type <= ITEMGET(12,246)) ))
	{
		Attribute2=0;
	}
	...
	if ( p->RequireLevel != 0 )
	{
		...
		else if ( _type >= ITEMGET(12,240) && _type <= ITEMGET(12,246) )
		{
			this->m_RequireLevel = p->RequireLevel;
		}
	...
	if ( p->Defense > 0 )	
	{
		...
		else 
		{
			...
			if ( ( _type >= ITEMGET(12,36) && _type <= ITEMGET(12,40)) || ( _type >= ITEMGET(12,240) && _type <= ITEMGET(12,246)) )
			{
	...
	if ( Option2 != 0 )
	{
		...
		if ( _type >= ITEMGET(12,240) && _type <= ITEMGET(12,246) )	//Season 4.7 4th Wings
		{
			this->m_Special[this->m_SpecialNum] = 84;
			this->m_Option2 = 1;
		}
	...
	if ( Option3 != 0 )
	{
		...
		else if ( _type == ITEMGET(12,241) ) // Wing of Demonic -> Wing 4
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,240) ) // Wing of Heaven
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,242) ) // Wing of Blossom
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,243) ) // Wing of Thunder
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,244) ) // Wing of Raven
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if ( _type == ITEMGET(12,245) ) // Wing of Eternal
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
		...
		else if (_type == ITEMGET(12,246)) // Wing of Legend
		{
			this->m_Option3 = Option3;
			this->m_Special[this->m_SpecialNum] = 0x55;
	...
	if ( _type >= ITEMGET(12,36) && _type <= ITEMGET(12,40) || _type >= ITEMGET(12,240) && _type <= ITEMGET(12,246) || _type == ITEMGET(12,43))
	{
		if ( (this->m_NewOption &1) )
		{
...
void CItem::Value()
{
	...
	else if ( this->m_Type == ITEMGET(14,170) ) // Crystal Feather
	{
		Gold = 3000000; // Custom Item
	}
	else if (this->m_Type == ITEMGET(14,171) ) // Legend Amulet
	{
		Gold = 6000000; // Custom Item
	}
	else if (this->m_Type == ITEMGET(14,172) ) // Golden Fragment
	{
		Gold = 6000000; // Custom Item
	}
	...
	else if (this->m_Type == ITEMGET(13,64) ) // Demon Price
	{
		Gold = 3000;
	}
	else if (this->m_Type == ITEMGET(13,65) ) // Fairy Price
	{
		Gold = 3000;
	}
	else if (this->m_Type == ITEMGET(13,67) ) // Rudolf Price
	{
		Gold = 3000;
	}
	...
	else if( this->m_Type == ITEMGET(13,80) ) // Panda Pet
	{
		Gold = 3000;
	}
	else if( this->m_Type == ITEMGET(13,123) ) // Skeleton Pet
	{
		Gold = 3000;
	}
	else if( this->m_Type == ITEMGET(13,106) ) // Unicorn Pet
	{
		Gold = 3000;
	}
	else if (this->m_Type == ITEMGET(13, 110)) // Dragon Pet
	{
		Gold = 3000;
	}
	else if (this->m_Type == ITEMGET(13,140) ) // Horrocrux of Fire
	{
		Gold = 90000000;
	}
	else if (this->m_Type == ITEMGET(13,141) ) // Horrocrux of Water
	{
		Gold = 90000000;
	}
	else if (this->m_Type == ITEMGET(13,142) ) // Horrocrux of Earth
	{
		Gold = 90000000;
	}
	else if (this->m_Type == ITEMGET(13,143) ) // Horrocrux of Wind
	{
		Gold = 90000000;
	}
	else if (this->m_Type == ITEMGET(13,144) ) // Horrocrux of Thunder
	{
		Gold = 90000000;
	}
	else if (this->m_Type == ITEMGET(13,145) ) // Horrocrux of Ice
	{
		Gold = 90000000;
	}
	...
	else if ( (Type == 12 && this->m_Type > ITEMGET(12,6) && (this->m_Type < ITEMGET(12,36) && this->m_Type > ITEMGET(12,43)) && (this->m_Type < ITEMGET(12,240) && this->m_Type > ITEMGET(12,246)) ) || Type == 13 || Type == 15 ) //Third Wings Addition
	{
	...
	else
	{
		...
		else if( Type == 12 && (this->m_Type >= ITEMGET(12,240) && this->m_Type <= ITEMGET(12,246)) ) //4th Wings
		{
			Gold = 1000000;//(Level2+40)*Level2*Level2*11+40000000;
		}
	...
	if ( (this->m_Type < ITEMGET(14,0) || this->m_Type >  ITEMGET(14,8)) &&
		  ...
		  this->m_Type != ITEMGET(13,106) && //Season 4.9 Unicorn Pet
		  this->m_Type != ITEMGET(13,110) && //Season 4.9 Dragon Pet
		  this->m_Type != ITEMGET(13,123) && //Season 4.9 Skeleton Pet
...
{
	if ( this->m_Type >= ITEMGET(12,240) && this->m_Type <= ITEMGET(12,246) )
	{
		if ( this->m_Durability < 1.0f )
		{
			return 0;
