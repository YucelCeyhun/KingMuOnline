...
void CKanturu::SetState_BATTLE_STANDBY() //identical gs-cs 56
{
...
int CKanturu::CheckEnterKanturu(int iUserIndex)
{
		 ...
		 this->m_BattleOfMaya.GetEntrancePermit() == TRUE)
	{
		...
		if ( (gObj[iUserIndex].pInventory[7].m_Type < ITEMGET(12,0) || gObj[iUserIndex].pInventory[7].m_Type > ITEMGET(12,6) ) &&
			 ...
			 gObj[iUserIndex].pInventory[8].m_Type != ITEMGET(13,99) &&
			 ...
			 (gObj[iUserIndex].pInventory[7].m_Type < ITEMGET(12,240) || gObj[iUserIndex].pInventory[7].m_Type > ITEMGET(12,252)))
		{
