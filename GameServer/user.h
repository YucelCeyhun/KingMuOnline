...
enum MAP_INDEX
{
	...
	MAP_INDEX_DUEL_ZONE				= 0x40,
	MAP_INDEX_ARKANIA				= 0x42,
	MAP_INDEX_LORENMARKET			= 0x43,
	MAP_INDEX_KALIMDOR				= 0x44,
	MAP_INDEX_KARUTAN				= 0x45,
	MAP_INDEX_ACHERON				= 0x46,
};
...
struct OBJECTSTRUCT
{
	...
	int		m_iCurrentWarehouseId;
	int		m_iWarehouseExpandCount;
...
BOOL checkMaxStat(BYTE type,LPOBJ lpObj,int addStats=1);
...
BOOL gObjSparkySprite(LPOBJ lpObj);
...
int gObjAttack(LPOBJ lpObj, LPOBJ lpTargetObj, class CMagicInf* lpMagic, int magicsend, BYTE MSBFlag, int AttackDamage, BOOL bCombo);
...
int gObjItemAddSocketEx(LPOBJ lpObj, int source, int target);
int gObjItemAddAncientEx(LPOBJ lpObj, int source, int target);
int gObjItemAddExcellentEx(LPOBJ lpObj, int source, int target);
int gObjItemAddOptionEx(LPOBJ lpObj, int source, int target);
int gObjItemAddSkillEx(LPOBJ lpObj, int source, int target);
int gObjItemAddLuckEx(LPOBJ lpObj, int source, int target);
int gObjItemLevelUpEx(LPOBJ lpObj, int source, int target);
int gObjWingUpgradeEx(LPOBJ lpObj, int source, int target);
int gObjWingUpgradeEx2(LPOBJ lpObj, int source, int target);
// ----
int gObjDragonHelmEvolveEx(LPOBJ lpObj, int source, int target);
int gObjDragonArmorEvolveEx(LPOBJ lpObj, int source, int target);
int gObjDragonPantsEvolveEx(LPOBJ lpObj, int source, int target);
int gObjDragonGlovesEvolveEx(LPOBJ lpObj, int source, int target);
int gObjDragonBootsEvolveEx(LPOBJ lpObj, int source, int target);
// ----
int gObjGuardianHelmEvolveEx(LPOBJ lpObj, int source, int target);
int gObjGuardianArmorEvolveEx(LPOBJ lpObj, int source, int target);
int gObjGuardianPantsEvolveEx(LPOBJ lpObj, int source, int target);
int gObjGuardianGlovesEvolveEx(LPOBJ lpObj, int source, int target);
int gObjGuardianBootsEvolveEx(LPOBJ lpObj, int source, int target);
// ----
int gObjLegendaryHelmEvolveEx(LPOBJ lpObj, int source, int target);
int gObjLegendaryArmorEvolveEx(LPOBJ lpObj, int source, int target);
int gObjLegendaryPantsEvolveEx(LPOBJ lpObj, int source, int target);
int gObjLegendaryGlovesEvolveEx(LPOBJ lpObj, int source, int target);
int gObjLegendaryBootsEvolveEx(LPOBJ lpObj, int source, int target);
// ----
...
//Added for test new Golden Archer System
int gObjFind10Rena(int aIndex);
int gObjDelete10Rena(int aIndex);
int gObjFind20Rena(int aIndex);
int gObjDelete20Rena(int aIndex);
int gObjFind30Rena(int aIndex);
int gObjDelete30Rena(int aIndex);
// -----------------------------------------
//Added for test new Pack System for Custom Jewels
int gObjFind10JewelLevel(int aIndex);
int gObjFind20JewelLevel(int aIndex);
int gObjDelete10JewelLevel(int aIndex);
int gObjDelete20JewelLevel(int aIndex);
int gObjFind10JewelLuck(int aIndex);
int gObjDelete10JewelLuck(int aIndex);
int gObjFind10JewelSkill(int aIndex);
int gObjDelete10JewelSkill(int aIndex);
int gObjFind10JewelOption(int aIndex);
int gObjDelete10JewelOption(int aIndex);
int gObjFind10JewelExcellent(int aIndex);
int gObjDelete10JewelExcellent(int aIndex);
int gObjFind10JewelAncient(int aIndex);
int gObjDelete10JewelAncient(int aIndex);
int gObjFind10JewelSocket(int aIndex);
int gObjDelete10JewelSocket(int aIndex);
// -----------------------------------------
//Added for Unpack System for Custom Jewels
int gObjFindBundledJewelLevel(int aIndex);
int gObjDeleteBundledJewelLevel(int aIndex);
int gObjFindBundledJewelLuck(int aIndex);
int gObjDeleteBundledJewelLuck(int aIndex);
int gObjFindBundledJewelSkill(int aIndex);
int gObjDeleteBundledJewelSkill(int aIndex);
int gObjFindBundledJewelOption(int aIndex);
int gObjDeleteBundledJewelOption(int aIndex);
int gObjFindBundledJewelExcellent(int aIndex);
int gObjDeleteBundledJewelExcellent(int aIndex);
int gObjFindBundledJewelAncient(int aIndex);
int gObjDeleteBundledJewelAncient(int aIndex);
int gObjFindBundledJewelSocket(int aIndex);
int gObjDeleteBundledJewelSocket(int aIndex);
// -----------------------------------------
