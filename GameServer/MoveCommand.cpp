...
BOOL CMoveCommand::CheckEquipmentToMove(LPOBJ lpObj, int iTargetMapNumber)
{
	...
	if ( iTargetMapNumber == MAP_INDEX_ICARUS )
	{
		if ( (lpObj->pInventory[8].m_Type != ITEMGET(13,3) &&
			 ...
			 lpObj->pInventory[8].m_Type != ITEMGET(13,97) &&//Season 4.9 addon
			 lpObj->pInventory[8].m_Type != ITEMGET(13,98) &&//Season 4.9 addon
			 ...
			 lpObj->pInventory[7].m_Type != ITEMGET(12,240) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,241) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,242) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,243) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,244) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,245) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,246) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,247) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,248) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,249) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,250) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,251) &&//Season 4.7 addon
			 lpObj->pInventory[7].m_Type != ITEMGET(12,252) &&//Season 4.7 addon
