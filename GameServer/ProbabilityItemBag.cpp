...
BOOL CProbabilityItemBag::DropPandoraBoxReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if (this->m_bLoad == FALSE)
		return FALSE;
	...
	if (this->GetBagCount() > 0)
	{
		...
		{
			MapC[lpObj->MapNumber].MoneyItemDrop(this->m_iDropZen, cX, cY);
			LogAddTD("[PandoraBox] DropPandoraBoxChaosItem [%s][%s] [%d Zen]", lpObj->AccountID, lpObj->Name, this->m_iDropZen);
			return 1;
		}
		...
		ItemSerialCreateSend(lpObj->m_Index, btMapNumber, x, y, type, level, dur, Option1, Option2, Option3, lpObj->m_Index, loc12, 0);
		LogAddTD("[PandoraBox] DropPandoraBoxChaosItem [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
			lpObj->AccountID, lpObj->Name, btMapNumber, x, y, ItemAttribute[type].Name, type, level, Option1, Option2, Option3, loc12);
...
BOOL CProbabilityItemBag::DropLegendary1BoxReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if (this->m_bLoad == FALSE)
		return FALSE;
	...
	if (this->GetBagCount() > 0)
	{
		...
		{
			MapC[lpObj->MapNumber].MoneyItemDrop(this->m_iDropZen, cX, cY);
			LogAddTD("[LegendaryBox1] DropLegendaryBox1ChaosItem [%s][%s] [%d Zen]", lpObj->AccountID, lpObj->Name, this->m_iDropZen);
			return 1;
		}
		...
		ItemSerialCreateSend(lpObj->m_Index, btMapNumber, x, y, type, level, dur, Option1, Option2, Option3, lpObj->m_Index, loc12, 0);
		LogAddTD("[LegendaryBox1] DropLegendaryBox1ChaosItem [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
			lpObj->AccountID, lpObj->Name, btMapNumber, x, y, ItemAttribute[type].Name, type, level, Option1, Option2, Option3, loc12);
...
BOOL CProbabilityItemBag::DropLegendary2BoxReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if (this->m_bLoad == FALSE)
		return FALSE;
	...
	if (this->GetBagCount() > 0)
	{
		...
		{
			MapC[lpObj->MapNumber].MoneyItemDrop(this->m_iDropZen, cX, cY);
			LogAddTD("[LegendaryBox2] DropLegendaryBox2ChaosItem [%s][%s] [%d Zen]", lpObj->AccountID, lpObj->Name, this->m_iDropZen);
			return 1;
		}
		...
		ItemSerialCreateSend(lpObj->m_Index, btMapNumber, x, y, type, level, dur, Option1, Option2, Option3, lpObj->m_Index, loc12, 0);
		LogAddTD("[LegendaryBox2] DropLegendaryBox2ChaosItem [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
			lpObj->AccountID, lpObj->Name, btMapNumber, x, y, ItemAttribute[type].Name, type, level, Option1, Option2, Option3, loc12);
...
BOOL CProbabilityItemBag::DropLegendary3BoxReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if (this->m_bLoad == FALSE)
		return FALSE;
	...
	if (this->GetBagCount() > 0)
	{
		...
		{
			MapC[lpObj->MapNumber].MoneyItemDrop(this->m_iDropZen, cX, cY);
			LogAddTD("[LegendaryBox3] DropLegendaryBox3ChaosItem [%s][%s] [%d Zen]", lpObj->AccountID, lpObj->Name, this->m_iDropZen);
			return 1;
		}
		...
		ItemSerialCreateSend(lpObj->m_Index, btMapNumber, x, y, type, level, dur, Option1, Option2, Option3, lpObj->m_Index, loc12, 0);
		LogAddTD("[LegendaryBox3] DropLegendaryBox3ChaosItem [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
			lpObj->AccountID, lpObj->Name, btMapNumber, x, y, ItemAttribute[type].Name, type, level, Option1, Option2, Option3, loc12);
...
BOOL CProbabilityItemBag::DropRaklionSelupanMonsterReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY) //004B31D0
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
