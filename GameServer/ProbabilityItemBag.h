...
public:
	...
	BOOL DropPandoraBoxReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
	BOOL DropLegendary1BoxReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
	BOOL DropLegendary2BoxReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
	BOOL DropLegendary3BoxReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
