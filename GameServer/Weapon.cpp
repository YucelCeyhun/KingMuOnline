...
BOOL CWeapon::Attack(LPOBJ lpObj, LPOBJ lpTargetObj, CMagicInf * lpMagic, int iCriticalDamage, int iActionType)
{
	...
	int iSkillMagumReduceDefense = gObjGetActiveEffect(lpObj, 23);

	iTargetDefense -= (iTargetDefense * iSkillMagumReduceDefense)/100;
	...
	{
		if(gObjSearchActiveEffect(lpTargetObj, AT_WIZARD_DEFENSE) == 1 && iAttackDamage > 0)
		{
