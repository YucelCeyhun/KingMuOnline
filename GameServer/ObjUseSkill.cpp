...
int CObjUseSkill::GetUseMana(int aIndex, CMagicInf * lpMagic)
{
	...
	loc4 -= lpObj->m_MLPassiveSkill.m_iML_IncreaseManaReduction * loc4 / 100.0f;
...
BOOL CObjUseSkill::SkillChangeUse(int aIndex) //
{
	...
	// Transformation Panda Skill Slot 10 Here
	...
	// Transformation Panda Skill Slot 11 Here
...
BOOL CObjUseSkill::SkillKnightRush(int aIndex, int aTargetIndex, CMagicInf * lpMagic) // Castle Siege Skill - DK
{
	if(OBJMAX_RANGE(aIndex) == false)
	{
		return false;
...
BOOL CObjUseSkill::SkillWizardJavalin(int aIndex, int aTargetIndex, CMagicInf * lpMagic) // Castle Siege Skill - DW SUM
{
	if(OBJMAX_RANGE(aIndex) == false)
	{
		return false;
...
BOOL CObjUseSkill::SkillElfRush(int aIndex, int aTargetIndex, CMagicInf * lpMagic) // Castle Siege Skill - ELF
{
	if(OBJMAX_RANGE(aIndex) == false)
	{
		return false;
...
BOOL CObjUseSkill::SkillMagumOneFlash(int aIndex, int aTargetIndex, CMagicInf * lpMagic) // Castle Siege Skill - MG
{
	if(OBJMAX_RANGE(aIndex) == false)
	{
		return false;
...
BOOL CObjUseSkill::SkillMagumDeathCannon(int aIndex, int aTargetIndex, CMagicInf * lpMagic) // Castle Siege Skill - MG 2
{
	if(OBJMAX_RANGE(aIndex) == false)
	{
		return false;
...
BOOL CObjUseSkill::SkillDarklordSpaceSplit(int aIndex, int aTargetIndex, CMagicInf * lpMagic) // Castle Siege Skill - DL
{
	if(OBJMAX_RANGE(aIndex) == false)
	{
		return false;
...
int CObjUseSkill::SkillExpansionWizardry(int aIndex, int aTargetIndex, CMagicInf *lpMagic) //004F8CF0
{
	...
	int iWizardryDamage = (float)(lpObj->Energy/9) * (float)0.f;
