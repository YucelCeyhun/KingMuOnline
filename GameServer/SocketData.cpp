...
BYTE CSeedSphere::SetInfo(CSeed * lpSeed, BYTE slot_count)
{
	...
	switch(lpSeed->m_btElementIndex)
	{
		case 1:
		{
			this->m_iItemIndex = ITEMGET(12,100);
		}
		break;
		// --
		case 2:
		{
			this->m_iItemIndex = ITEMGET(12,101);
		}
		break;
		// --
		case 3:
		{
			this->m_iItemIndex = ITEMGET(12,102);
		}
		break;
		// --
		case 4:
		{
			this->m_iItemIndex = ITEMGET(12,103);
		}
		break;
		// --
		case 5:
		{
			this->m_iItemIndex = ITEMGET(12,104);
		}
		break;
		// --
		case 6:
		{
			this->m_iItemIndex = ITEMGET(12,105);
		}
		break;
		// --
		case 7:
		{
			// -> Reserved to Unique Sphere Wz LOL xD
		}
		break;
		// --
		default:
