...
BOOL TMonsterAIElement::ApplyElementHealSelf(int iIndex, int iTargetIndex, TMonsterAIState * pAIState)
{
	...
	gObjApplyBuffEffectDuration(lpObj, AT_INCREASE_DEFENSE, 0, 0, 0, 0, -10); //season3 add-on
...
BOOL TMonsterAIElement::ApplyElementSpecialImmune(int iIndex, int iTargetIndex, TMonsterAIState * pAIState)
{
	...
	gObjApplyBuffEffectDuration(lpObj, AT_IMMUNE_MAGIC, 0, 0, 0, 0, this->m_iX); //season3 add-on
	gObjApplyBuffEffectDuration(lpObj, AT_IMMUNE_HARM, 0, 0, 0, 0, this->m_iY); //season3 add-on
