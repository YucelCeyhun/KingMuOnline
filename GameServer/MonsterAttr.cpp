...
void CMonsterAttr::LoadAttr(char* filename)
{
	...
	while ( true )
	{
		...
		if ( Token == NUMBER )
		{
			this->m_MonsterAttr[n].m_Index = TokenNumber;					Token = GetToken();
			this->m_MonsterAttr[n].m_Rate = TokenNumber;					Token = GetToken();
			strcpy(this->m_MonsterAttr[n].m_Name, TokenString);				Token = GetToken();
			this->m_MonsterAttr[n].m_Level = TokenNumber;					Token = GetToken();
			this->m_MonsterAttr[n].m_Hp = TokenNumber;						Token = GetToken();
			this->m_MonsterAttr[n].m_Mp = TokenNumber;						Token = GetToken();
			this->m_MonsterAttr[n].m_DamageMin = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_DamageMax = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_Defense = TokenNumber;					Token = GetToken();
			this->m_MonsterAttr[n].m_MagicDefense = TokenNumber;			Token = GetToken();
			this->m_MonsterAttr[n].m_AttackRating = TokenNumber;			Token = GetToken();
			this->m_MonsterAttr[n].m_Successfulblocking = TokenNumber;		Token = GetToken();
			this->m_MonsterAttr[n].m_MoveRange = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_AttackType = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_AttackRange = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_ViewRange = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_MoveSpeed = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_AttackSpeed = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_RegenTime = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_Attribute = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_ItemRate = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_MoneyRate = TokenNumber;				Token = GetToken();
			this->m_MonsterAttr[n].m_MaxItemLevel = TokenNumber;			Token = GetToken();
			this->m_MonsterAttr[n].m_MonsterSkill = TokenNumber;			Token = GetToken();
			this->m_MonsterAttr[n].m_Resistance[R_ICE]  = TokenNumber;		Token = GetToken();
			this->m_MonsterAttr[n].m_Resistance[R_POISON] = TokenNumber;	Token = GetToken();
			this->m_MonsterAttr[n].m_Resistance[R_LIGHTNING] = TokenNumber;	Token = GetToken();
